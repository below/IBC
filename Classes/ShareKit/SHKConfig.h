...
#define SHKMyAppName			@"IBC Mobile"
#define SHKMyAppURL				@"http://mtb-news.de"
...
#define SHKDeliciousConsumerKey		@"dj0yJmk9NWZWSjY4RmNoTGFnJmQ9WVdrOU5tdFNUbE5ITnpBbWNHbzlNVGMwTnpneE16RTJNZy0tJnM9Y29uc3VtZXJzZWNyZXQmeD01YQ--"
#define SHKDeliciousSecretKey		@"b47f165d10581e77e5dad2f3462f068e53d96235"
...
#define SHKReadItLaterKey			@"55bA8Ed9d1c17k5aKNpcQ3dr1aTow430"
 ...
 */
#define SHKTwitterConsumerKey		@"HTCUPiemed5QcJzpIxQ"
#define SHKTwitterSecret			@"hLmnqXAZyu2UVKAleNFPyC1Qk7gQgjytbDRKE91A"
#define SHKTwitterCallbackUrl		@"http://www.xyz1234.com" // You need to set this if using OAuth, see note above (xAuth users can skip it)
...
#define SHKBarTintColorRed			171 / 255.0 // Value between 0-255, set all to -1 for default
#define SHKBarTintColorGreen		9 / 255.0 // Value between 0-255, set all to -1 for default
#define SHKBarTintColorBlue			13 / 255.0 // Value between 0-255, set all to -1 for default
